...
/// @enum  FPRO_MERGEALGO
/// @brief Merging algorithms available in the API
///
/// This enum is for use with the #FPROFrame_GetVideoFrameUnpacked() API to retrieve unpacked and
/// merged image data.  This enum tells the API which algorithm to use when merging data. 
/// See  #FPROUNPACKEDIMAGES for more information on unpacking and merging in general.
/// See #FPROAlgo_SetHardwareMergeEnables(), #FPROAlgo_SetHardwareMergeReferenceFrames() and #FPRO_REFFRAMES
/// for more information on the hardware merge (and API emulation) setup.
///
/// @var FPRO_MERGEALGO::FPROMERGE_ALGO 
/// @brief Original merge algorithm based on camera settings.
/// @var FPRO_MERGEALGO::FPROMERGE_ALGO_REF_FRAME 
/// @brief Emulates the hardware merge algorithm found on the FLI PCIE Fibre cards.  Reference
/// frames are required to be sent to the API for this to function correctly.  Identity reference
/// frames are used if none are sent.
typedef enum
{
	FPROMERGE_ALGO = 0,
...
/// @brief Specifies which merging algorithm to use when merging the image data. See #FPRO_MERGEALGO.
...
/// frame data.  See #FPROCAP capabilities structure for details about reference rows.
///
///	@param iHandle - The handle to an open camera device returned from FPROCam_Open()
...
/// <br>
/// <br>
/// This function will also perform Bias and Flat Field correction on the Low Gain and High Gain frames if those operations are 
/// set up prior to this call with the #FPROFrame_SetUnpackingBiasFrames() and #FPROFrame_SetUnpackingFlatFieldFrames() API's.
/// <br>
///
///	@param iHandle - The handle to an open camera device returned from FPROCam_Open()
///	@param pFrameData - The buffer to store the frame data.
...
/// @param uiMaxSize - The size of the string buffer pMetaString.
///
/// @return Greater than or equal to 0 on success, less than 0 on failure.
...
//////////////////////////////////////////
///
/// @brief Sets Bias frame correction to be used during unpacking.
///
/// This function is meant to be used when you intend to use the #FPROFrame_GetVideoFrameUnpacked() API
/// to retrieve image data.  During unpacking, the specified Bias frames will be applied to the
/// raw image data.  The operation is a simple subtraction on the raw image data. See #FPROFrame_GetVideoFrameUnpacked()
/// for more information.
/// <br>
/// <br>
/// The dimensions of the frames you pass must match the dimensions of the image frames you are collecting including
/// pre and prost row reference pixels and pre and post frame reference rows.  If they
/// do not match, then the correction is not applied by the #FPROFrame_GetVideoFrameUnpacked() and 
/// #FPROFrame_GetVideoFrameUnpacked() will return a failure.
/// <br>
/// <br>
/// The frame data you pass must be in row major order. The API copies the passed frames to an internal buffer so you may 
/// discard the buffers on return.  Passing NULL for a frame pointer disables the correction for the given frame (and deletes
/// the internal buffer copy).
/// <br>
///
///	@param iHandle - The handle to an open camera device returned from FPROCam_Open()
///	@param uiWidth - The width of the bias frames in pixels.
/// @param uiHeight - The height of the bias frames in pixels.
/// @param pLowFrame - The bias correction to be applied to the Low Gain Image.
/// @param pHighFrame - The bias correction to be applied to the High Gain Image.
///
/// @return Greater than or equal to 0 on success, less than 0 on failure.
...
//////////////////////////////////////////
///
/// @brief Sets Flat Field correction to be used during unpacking.
///
/// This function is meant to be used when you intend to use the #FPROFrame_GetVideoFrameUnpacked() API
/// to retrieve image data.  During unpacking, the specified Flat Field Correction frames will be applied to the
/// raw image data. See #FPROFrame_GetVideoFrameUnpacked() for more information.
/// <br>
/// <br>
/// The dimensions of the frames you pass must match the dimensions of the image frames you are collecting
/// including pre and prost row reference pixels and pre and post frame reference rows.  If they
/// do not match, then the correction is not applied by the #FPROFrame_GetVideoFrameUnpacked() and 
/// #FPROFrame_GetVideoFrameUnpacked() will return a failure.
/// <br>
/// <br>
...
///
///	@param iHandle - The handle to an open camera device returned from FPROCam_Open()
///	@param uiWidth - The width of the Flat Field frames in pixels.
/// @param uiHeight - The height of the Flat Field frames in pixels.
/// @param pLowFrame - The Flat Field correction to be applied to the Low Gain Image.
/// @param pHighFrame - The Flat Field correction to be applied to the High Gain Image.
///
/// @return Greater than or equal to 0 on success, less than 0 on failure.
...
/// passed in was too small.  In this case, the *pCapLength value is the size of the buffer
